...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.z3e1b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
  try {
    ...
    app.post('/coffee',async(req,res)=>{
      const coffeeNew=req.body;
      console.log(coffeeNew)
      const result=await coffeeCollection.insertOne(coffeeNew)
      res.send(result)
    })
